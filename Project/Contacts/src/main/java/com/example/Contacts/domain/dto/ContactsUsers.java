package com.example.Contacts.domain.dto;
...
public class ContactsUsers implements UserDetails {
    ...
    @OneToMany(mappedBy = "contactOwner", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    private Set<ContactsList> contacts;
    ...
    public Set<ContactsList> getContacts() {
        return contacts;
    }
    public void setContacts(Set<ContactsList> contacts) {
